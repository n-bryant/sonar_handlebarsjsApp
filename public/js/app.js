        ...
        class Band {
            constructor() {
                ...
                this.albums = [{
                    ...
                    "id": 2,
                    "name": "Carving Desert Canyons"
                }];
                this.id = 1;
                this.biography = {
                    background: "Scale the Summit is an American instrumental progressive metal band based out of Houston, Texas.",
            ...
            build() {
                const source = $('#bands-template').html();
